...
export const MODELS: Record<string, { id: string; name: string; params: string; description: string }[]> = {
  'Computer Vision': [
    ...
    { id: 'yolov9c',         name: 'YOLOv9c',            params: '25.3M', description: 'Programmable Gradient Information for object detection' },
    { id: 'detr_resnet50',   name: 'DETR-ResNet50',      params: '41M',   description: 'Facebook end-to-end transformer object detection' },
    { id: 'efficientnetb0',  name: 'EfficientNet-B0',    params: '5.3M',  description: 'Compound scaling for balanced efficiency' },
    { id: 'nanodet_plus',    name: 'NanoDet-Plus',       params: '1.2M',  description: 'Ultra-lightweight anchor-free detector' },
  ],
  'LLM': [
    ...
    { id: 'gemma2_2b',   name: 'Gemma 2 2B',        params: '2B',   description: 'Google lightweight open model' },
    { id: 'smollm2',     name: 'SmolLM2 1.7B',      params: '1.7B', description: 'Hugging Face ultra-compact LLM' },
    { id: 'mistral_7b',  name: 'Mistral 7B',         params: '7B',   description: 'Mistral AI high-efficiency open model' },
    { id: 'llama3_1_8b', name: 'LLaMA 3.1 8B',      params: '8B',   description: 'Meta latest generation foundational model' },
    { id: 'deepseek_r1', name: 'DeepSeek-R1-Distill', params: '1.5B', description: 'DeepSeek reasoning distilled small model' },
  ],
  'Auto Speech Recognition': [
    ...
    { id: 'whisper_tiny',   name: 'Whisper Tiny',      params: '39M',  description: 'OpenAI ultra-lightweight STT' },
    { id: 'conformer',     name: 'Conformer-CTC',     params: '120M', description: 'Google conformer for streaming ASR' },
    { id: 'hubert_base',   name: 'HuBERT Base',       params: '95M',  description: 'Meta self-supervised speech representation' },
    { id: 'fastconformer',  name: 'FastConformer',     params: '114M', description: 'NVIDIA optimized conformer for edge' },
    { id: 'squeezeformer',  name: 'Squeezeformer',    params: '64M',  description: 'Efficient conformer variant for edge devices' },
    { id: 'zipformer',     name: 'Zipformer',         params: '78M',  description: 'Next-gen ASR architecture with zip attention' },
  ],
  'BCI': [
    ...
    { id: 'eeg_conformer',  name: 'EEG-Conformer', params: '3.2M', description: 'Convolution-enhanced transformer for EEG' },
    { id: 'fbcnet',        name: 'FBCNet',        params: '12K',  description: 'Filter-bank CNN for multi-band EEG features' },
    { id: 'tidnet',        name: 'TIDNet',        params: '86K',  description: 'Thinker invariant deep network for EEG' },
    { id: 'atcnet',        name: 'ATCNet',        params: '115K', description: 'Attention temporal convolutional network for EEG' },
    { id: 'eeginception',   name: 'EEG-Inception', params: '42K',  description: 'Inception module adapted for EEG signals' },
    { id: 'bciiv2a_cnn',   name: 'MI-CNN',        params: '28K',  description: 'Motor imagery CNN baseline' },
  ],
}
