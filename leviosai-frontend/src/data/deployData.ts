...
export function getDeployLogLines(device: string, projectName: string): DeployLogLine[] {
  return [
    ...
    { delay: 1500, text: 'SSH handshake complete ✓', type: 'ok' },
    { delay: 2000, text: `Uploading project "${projectName}" (2.3 MB)...`, type: 'info' },
    { delay: 3200, text: 'File transfer: 100% ✓', type: 'ok' },
    { delay: 3700, text: 'Installing dependencies...', type: 'info' },
    { delay: 4800, text: 'torch==2.4.0 installed ✓', type: 'ok' },
    { delay: 5300, text: 'opencv-python==4.10.0 installed ✓', type: 'ok' },
    { delay: 5800, text: 'Loading optimized model...', type: 'info' },
    { delay: 6800, text: 'Model loaded: model_opt.engine ✓', type: 'ok' },
    { delay: 7300, text: 'Running inference validation...', type: 'info' },
    { delay: 8500, text: 'Inference test: 10/10 PASSED ✓', type: 'ok' },
    { delay: 9000, text: 'Starting benchmark suite...', type: 'info' },
    { delay: 10200, text: 'Benchmark: latency, throughput, memory — DONE ✓', type: 'ok' },
